        ...
        <form method="POST" action="{{ route('admin.empresas.store') }}">
          ...
          <div class="col-md-6">
              <div class="form-group">
                <label>Nombre:</label>
                <input name="nombre" style="text-transform: uppercase;" class="form-control" placeholder="Ingresa el nombre">
              </div>
              <div class="form-group">
                <label>Leyenda:</label>
                <input name="leyenda" class="form-control" placeholder="Ingresa la leyenda">
              </div>
              <div class="form-group">
                <label>Leyenda Factura:</label>
                <textarea rows="10" name="leyenda_factura" type="text" class="form-control" placeholder="Ingresa la leyenda de factura"></textarea>
              </div>
          </div>
          <div class="col-md-6">
            <div class="form-group">
              <label>CUIT:</label>
              <input name="cuit" style="text-transform: uppercase;" class="form-control" placeholder="Ingresa el cuit">
            </div>
            <div class="form-group">
              <label>Direccion:</label>
              <input name="direccion" class="form-control" placeholder="Ingresa la direccion">
            </div>
            <div class="form-group">
              <label>Teléfono:</label>
              <input name="telefono" class="form-control" placeholder="Ingresa la telefono">
            </div>
            <div class="form-group">
              <label>Email:</label>
              <input type="email" name="email" class="form-control" placeholder="Ingresa la email">
            </div>
            <div class="form-group">
              <label>Responsable:</label>
              <input name="responsable" class="form-control" placeholder="Ingresa la responsable">
            </div>
          </div>
